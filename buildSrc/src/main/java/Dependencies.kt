object Dependencies {
    ...
    val composeUi by lazy { "androidx.compose.ui:ui:1.7.3" }
    val composeUiGraphics by lazy {"androidx.compose.ui:ui-graphics:1.7.3"}
    val composeUiToolingPreview by lazy { "androidx.compose.ui:ui-tooling-preview:1.7.3" }
    val composeMaterial3 by lazy { "androidx.compose.material3:material3:1.3.0" }
    val navigationCompose by lazy { "androidx.navigation:navigation-compose:${Versions.navigationCompose}" }
    val composeTestJUnit4 by lazy { "androidx.compose.ui:ui-test:${Versions.compose}" }
